...
function generateV2HeaderCommands(documentId) {
  const importUrl = `https://jon-simpkins.github.io/revision/#/v2?workspace=${documentId}`

  return insertTextLines(1,
    [
      'Writing Workspace created in Revision!',
      '',
      '',
      'Do NOT edit this file directly, as doing so might cause Revision to be unable to open it again.',
      '',
      'The intention of storing this document in Google Docs is to clearly delegate all ownership of the content to you, '
        + 'and to allow your exclusive ability to modify the list of folks who can collaborate or view it.',
      '',
      `To invite other folks to collaborate in this workspace with you, share this doc with them in Google Docs, and then when they open:`,
      importUrl,
      'you\'ll be able to write together on a whole collection of scripts-in-progress.',
      '--------------------------',
      ''
    ],
    [
...
export {generateHeaderCommands, generateV2HeaderCommands, updateContentLine};
